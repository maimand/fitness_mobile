        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Header(
                  'Hello, ${Get.find<AuthService>().userModel.value?.fullname}',
                  rightSide: const UserPhoto(),
                ),
                const SizedBox(height: 12),
                const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20),
                  child: Text(
                    'Today is Chest day, are you ready for the push?',
                ...
                const ImageCardWithInternal(
                  image:
                  'https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/health/wp-content/uploads/2022/06/960x0-3-1.jpg',
                  title: 'Chest \nWorkout',
                  duration: '7 min',
                ...
                const ImageCardWithInternal(
                  image:
                  'https://fitnessvolt.com/wp-content/uploads/2022/06/30-Minute-Shoulder-Workout-750x422.jpg',
                  title: 'Shoulder \nWorkout',
                  duration: '7 min',
                ...
                const ImageCardWithInternal(
                  image:
                  'https://www.bodybuilding.com/images/2021/march/10-best-back-exercises-for-muscle-skinny-v2-830x467.jpg',
                  title: 'Back \nWorkout',
                  duration: '7 min',
                  tag: 'latissimus dorsi',
                ),
                ...
                const ImageCardWithInternal(
                  image:
                  'https://www.wheystore.vn/upload/news_optimize/wst_1605081641_abs_workout_la_gi__top_10_bai_tap_abs_workout_co_ban_cho_nguoi_moi_image_1605081641_1.jpg',
                  title: 'Abs \nWorkout',
                  duration: '7 min',
                  tag: 'abdominals',
                ),
